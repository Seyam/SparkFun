...
function checkSoundLevels(){
  ...
  console.log('value is: '+soundValue);
  ...
  if(soundValue >= threshold){
    ...
    request('https://data.sparkfun.com/input/g6RQKyL9nKIMpzr6VwD7?private_key=qznwo5y21oSAGjbJmV5Y&temp=' + soundValue + '&localtime=' + currentTime, function(error, response, body){
